        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="profile card card-body px-3 pt-3 pb-0">
                    <form action="{{route('post.stor')}}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-5">
                            ...
                            <input class="form-control"  id="bio" name="title" type="text" autocomplete="new-password" placeholder="Title">
                        ...
                        <div class="col-md-6 mb-4">
                            <img class="card-img-top img-fluid" id="image-preview" alt="poster">
                        </div>
                        <div class="input-group mb-3">
