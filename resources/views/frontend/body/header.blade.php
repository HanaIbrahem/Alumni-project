        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navcol-11">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link d-flex align-items-center" href="{{route('news.page')}}">
                    ...
                    </ul><a class="navbar-brand d-flex align-items-center d-none d-lg-block" href="#"><img class="img-fluid" src="{{asset('upload/brand-logo.png')}}"width="50px" height="4px" alt="bssblocks image placeholder"></a>
                    <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link d-flex align-items-center pe-0 btn btn-primary rounded-pill text-white pe-3 ms-3" href="{{route('login')}}">
