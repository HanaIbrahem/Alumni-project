            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" id="myForm" action="{{route('gallary.store')}}" enctype="multipart/form-data">
                            @csrf
                        ...
                        <!-- end row -->
                            <input type="submit" class="btn btn-primary waves-effect waves-light" value="Add Multi Image">
                        </form>
