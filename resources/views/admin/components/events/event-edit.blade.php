                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{route('event.update')}}" enctype="multipart/form-data"   method="post" id="myForm">
                                @csrf
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    placeholder="Title Here!">{{$event->title}}</textarea>                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    placeholder="Type Here!" value="{{$event->type}}">                 
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="datetime-local" value="{{$event->startdate}}" class="datepicker-default form-control picker__input" name="startdate" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="datetime-local" value="{{$event->enddate}}" class="datepicker-default form-control picker__input" name="expiredate" id="">
                                    </div>
                                </div>
                                ...
                                <div class="input-group mb-3 mt-4 form-group " >
                                    <img src="{{asset('upload/images/event/'.$event->image)}}" id="output" alt="" style="max-height: 200px" style="">
                                </div>
