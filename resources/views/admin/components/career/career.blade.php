...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <a href="{{route('career.destroy',$item->id)}}" class="btn btn-danger shadow btn-xs sharp" id="delete"><i class="fa fa-trash"></i></a>
                                                </div>												
                                            </td>	
                                        </tr>
                                    @endforeach
            ...
            <div class="col-12">
                <div class="card">
                    <a href="{{route('career.create')}}" class="btn btn-primary">Add a Career</a>
                </div>
            </div>
        </div>
